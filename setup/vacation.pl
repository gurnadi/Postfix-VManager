...
# connection details
our $db_username = 'vadmin';
our $db_password = 'vadmin_password';
our $db_name     = 'vmanager';
...
# instead of changing this script, you can put your settings to /etc/mail/postfixmanage/vacation.conf
# or /etc/postfixmanage/vacation.conf just use Perl syntax there to fill the variables listed above
# (without the "our" keyword). Example:
# $db_username = 'mail';
if (-f "/etc/mail/postfixmanage/vacation.conf") {
    require "/etc/mail/postfixmanage/vacation.conf";
} elsif (-f "/etc/postfixmanage/vacation.conf") {
    require "/etc/postfixmanage/vacation.conf";
}
